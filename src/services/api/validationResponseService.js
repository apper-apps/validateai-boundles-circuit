import mockData from '@/services/mockData/validationResponses.json';
...
class ValidationResponseService {
  ...
  async getByContentId(contentId) {
    await this.delay();
    return this.data.filter(item => item.contentId === parseInt(contentId));
  }
  ...
  async update(id, data) {
    ...
    throw new Error('Validation response not found');
  }
